...
requests, discussions) for this project, and also applies when an individual is
...
should stay private — via [GitHub Security Advisories](https://github.com/ahmedgeindy/deckforge/security/advisories/new)
